...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('third_party_auth', '0011_merge_20230515_1104'),
    ]

    operations = [
        migrations.AlterField(
            model_name='customproviderconfig',
            name='site',
            field=models.ForeignKey(default=2, help_text='The Site that this provider configuration belongs to.', on_delete=django.db.models.deletion.CASCADE, related_name='customproviderconfigs', to='sites.site'),
        ),
        migrations.AlterField(
